...
public class StevenitePickaxeItem extends PickaxeItem {
	public StevenitePickaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 6072;
			}
		...
		}, 1, -3f, new Item.Properties().tab(TheJamModFabricModTabs.TAB_JAM_MOD).fireResistant());
	}
